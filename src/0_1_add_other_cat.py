...
np.save(dirName + 'train2', sigs)
np.save(dirName + 'trainlabel2', ys)

sigs, ys = consolidateData(test, dirName)
np.save(dirName + 'test2', sigs)
np.save(dirName + 'testlabel2', ys)

sigs, ys = consolidateData(valid, dirName)
np.save(dirName + 'valid2', sigs)
np.save(dirName + 'validlabel2', ys)
